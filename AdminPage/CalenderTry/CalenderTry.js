    ...
    const check = () => {
        ...
        if (selectedBranch === "Computer") {
            if (selcetedSemester == 1) {
                ...
                navigation.navigate('1st Sem Past Attandence Admin')
            }
            else if (selcetedSemester == 2) {
                console.warn("2nd sem")
                navigation.navigate('2nd Sem Past Attandence Admin')
            }
            else if (selcetedSemester == 3) {
                console.warn("3rd sem")
                navigation.navigate('3rd Sem Past Attandence Admin')
            }
            else if (selcetedSemester == 4) {
                console.warn("4th sem")
                navigation.navigate('4th Sem Past Attandence Admin')
            }
            else if (selcetedSemester == 5) {
                console.warn("5th sem")
                navigation.navigate('5th Sem Past Attandence Admin')
            }
