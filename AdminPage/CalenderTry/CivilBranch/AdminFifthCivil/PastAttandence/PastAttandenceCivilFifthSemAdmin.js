...
const PastAttandenceCivilFifthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('5th Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilFifthSemAdmin;