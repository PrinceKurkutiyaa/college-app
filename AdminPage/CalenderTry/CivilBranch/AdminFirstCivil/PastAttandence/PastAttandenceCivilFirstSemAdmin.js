...
const PastAttandenceCivilFirstSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('1st Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilFirstSemAdmin;