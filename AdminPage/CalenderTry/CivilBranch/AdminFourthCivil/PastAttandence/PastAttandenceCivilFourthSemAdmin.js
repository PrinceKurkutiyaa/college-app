...
const PastAttandenceCivilFourthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('4th Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilFourthSemAdmin;