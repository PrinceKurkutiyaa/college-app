...
const PastAttandenceCivilSecondSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('2nd Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilSecondSemAdmin;