...
const PastAttandenceCivilSixthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('6th Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilSixthSemAdmin;