...
const PastAttandenceCivilThirdSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('3rd Sem Find Attandence Civil', { selectedDate: selected })
...
export default PastAttandenceCivilThirdSemAdmin;