...
const PastAttandenceElectricalFifthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('5th Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalFifthSemAdmin;