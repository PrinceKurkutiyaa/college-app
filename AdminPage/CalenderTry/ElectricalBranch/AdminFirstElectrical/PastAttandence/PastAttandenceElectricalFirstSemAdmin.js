...
const PastAttandenceElectricalFirstSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('1st Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalFirstSemAdmin;