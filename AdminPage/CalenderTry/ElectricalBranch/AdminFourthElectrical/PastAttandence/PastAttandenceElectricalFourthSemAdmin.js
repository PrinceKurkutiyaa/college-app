...
const PastAttandenceElectricalFourthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('4th Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalFourthSemAdmin;