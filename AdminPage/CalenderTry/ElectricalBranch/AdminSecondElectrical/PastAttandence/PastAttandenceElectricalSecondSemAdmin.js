...
const PastAttandenceElectricalSecondSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('2nd Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalSecondSemAdmin;