...
const PastAttandenceElectricalSixthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('6th Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalSixthSemAdmin;