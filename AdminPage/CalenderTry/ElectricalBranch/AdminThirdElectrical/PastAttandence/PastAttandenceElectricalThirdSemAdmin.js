...
const PastAttandenceElectricalThirdSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('3rd Sem Find Attandence Electrical', { selectedDate: selected })
...
export default PastAttandenceElectricalThirdSemAdmin;