...
import PastAttandence from "./PastAttandenceCompFifthSemAdmin";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceElectronicsFifthSemAdmin = ({ route }) => {
...
export default FindAttendanceElectronicsFifthSemAdmin;
