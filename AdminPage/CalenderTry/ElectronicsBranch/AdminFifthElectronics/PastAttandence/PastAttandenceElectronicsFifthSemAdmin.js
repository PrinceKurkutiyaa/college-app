...
const PastAttandenceElectronicsFifthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('5th Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsFifthSemAdmin;