...
import PastAttandence from "./PastAttandenceCompFirstSemAdmin";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceElectronicsFirstSemAdmin = ({ route }) => {
...
export default FindAttendanceElectronicsFirstSemAdmin;
