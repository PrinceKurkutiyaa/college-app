...
const PastAttandenceElectronicsFirstSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('1st Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsFirstSemAdmin;