...
const PastAttandenceElectronicsFourthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('4th Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsFourthSemAdmin;