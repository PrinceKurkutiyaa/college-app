...
import PastAttandence from "./PastAttandenceCompSecondSemAdmin";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceElectronicsSecondSemAdmin = ({ route }) => {
...
export default FindAttendanceElectronicsSecondSemAdmin;
