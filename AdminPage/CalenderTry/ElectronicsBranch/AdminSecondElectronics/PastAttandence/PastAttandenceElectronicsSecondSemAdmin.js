...
const PastAttandenceElectronicsSecondSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('2nd Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsSecondSemAdmin;