...
import PastAttandence from "./PastAttandenceCompSixthSemAdmin";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceElectronicsSixthSemAdmin = ({ route }) => {
...
export default FindAttendanceElectronicsSixthSemAdmin;
