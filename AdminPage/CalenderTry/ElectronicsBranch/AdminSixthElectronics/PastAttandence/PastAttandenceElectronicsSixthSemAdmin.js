...
const PastAttandenceElectronicsSixthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('6th Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsSixthSemAdmin;