...
const PastAttandenceElectronicsThirdSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('3rd Sem Find Attandence Electronics', { selectedDate: selected })
...
export default PastAttandenceElectronicsThirdSemAdmin;