...
const PastAttandenceMechanicalFifthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('5th Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalFifthSemAdmin;