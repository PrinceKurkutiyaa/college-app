...
const PastAttandenceMechanicalFirstSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('1st Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalFirstSemAdmin;