...
const PastAttandenceMechanicalFourthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('4th Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalFourthSemAdmin;