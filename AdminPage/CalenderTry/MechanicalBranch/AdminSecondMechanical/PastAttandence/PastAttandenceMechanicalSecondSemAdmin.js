...
const PastAttandenceMechanicalSecondSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('2nd Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalSecondSemAdmin;