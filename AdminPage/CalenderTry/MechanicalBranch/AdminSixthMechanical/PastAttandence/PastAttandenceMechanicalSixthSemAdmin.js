...
const PastAttandenceMechanicalSixthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('6th Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalSixthSemAdmin;