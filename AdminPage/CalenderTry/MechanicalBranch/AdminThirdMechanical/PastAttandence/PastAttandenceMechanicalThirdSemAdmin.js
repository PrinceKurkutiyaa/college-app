...
const PastAttandenceMechanicalThirdSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('3rd Sem Find Attandence Mechanical', { selectedDate: selected })
...
export default PastAttandenceMechanicalThirdSemAdmin;