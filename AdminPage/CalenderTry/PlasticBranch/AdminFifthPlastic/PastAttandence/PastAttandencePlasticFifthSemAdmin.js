...
const PastAttandencePlasticFifthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('5th Sem Find Attandence Plastic', { selectedDate: selected })
...
export default PastAttandencePlasticFifthSemAdmin;