...
const PastAttandencePlasticFirstSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('1st Sem Find Attandence Plastic', { selectedDate: selected })
...
export default PastAttandencePlasticFirstSemAdmin;