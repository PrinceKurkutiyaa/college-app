...
const PastAttandencePlasticSecondSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('2nd Sem Find Attandence Plastic', { selectedDate: selected })
...
export default PastAttandencePlasticSecondSemAdmin;