...
const PastAttandencePlasticSixthSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('6th Sem Find Attandence Plastic', { selectedDate: selected })
...
export default PastAttandencePlasticSixthSemAdmin;