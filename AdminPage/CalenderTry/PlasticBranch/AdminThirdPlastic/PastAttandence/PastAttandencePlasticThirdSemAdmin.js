...
const PastAttandencePlasticThirdSemAdmin = () => {
    ...
    const fetch = () => {
        if (selected) {
            navigation.navigate('3rd Sem Find Attandence Plastic', { selectedDate: selected })
...
export default PastAttandencePlasticThirdSemAdmin;