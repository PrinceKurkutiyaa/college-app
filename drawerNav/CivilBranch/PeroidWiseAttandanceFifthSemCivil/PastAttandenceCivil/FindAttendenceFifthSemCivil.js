...
const FindAttendanceFifthSemCivil = ({ route }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Civil 5th Semester</Text>
...
export default FindAttendanceFifthSemCivil;
