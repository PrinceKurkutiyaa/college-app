...
const FindAttendanceFourthSemCivil = ({ route }) => {
    const [Civil6thSemData, setCivil6thSemData] = useState([]);
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Civil 4th Semester</Text>
...
export default FindAttendanceFourthSemCivil;
