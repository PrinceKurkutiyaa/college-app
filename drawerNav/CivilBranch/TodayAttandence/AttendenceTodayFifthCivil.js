...
const AttendenceTodayFifthCivil = () => {
  const navigation = useNavigation();
  const [peroid, setPeroid] = useState('1');

  const submit = () => {
    if (peroid == 1) {
      navigation.navigate('5th Sem Civil 1st Peroid');
      console.warn('1');
    } else if (peroid == 2) {
      navigation.navigate('5th Sem Civil 2nd Peroid');
      console.warn('2');
    } else if (peroid == 3) {
      navigation.navigate('5th Sem Civil 3rd Peroid');
      console.warn('3');
    } else if (peroid == 4) {
      navigation.navigate('5th Sem Civil 4th Peroid');
      console.warn('4');
    } else if (peroid == 5) {
      navigation.navigate('5th Sem Civil 5th Peroid');
    } else if (peroid == 6) {
      navigation.navigate('5th Sem Civil 6th Peroid');
      console.warn('6');
    } else if (peroid == 7) {
...
export default AttendenceTodayFifthCivil;
