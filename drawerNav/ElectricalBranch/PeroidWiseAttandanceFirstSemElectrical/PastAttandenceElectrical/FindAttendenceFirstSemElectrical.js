...
const FindAttendanceFirstSemElectrical = ({ route }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electrical 1st Semester</Text>
...
export default FindAttendanceFirstSemElectrical;
