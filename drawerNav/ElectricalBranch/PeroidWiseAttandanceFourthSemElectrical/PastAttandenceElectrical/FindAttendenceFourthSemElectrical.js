...
const FindAttendanceFourthSemElectrical = ({ route }) => {
    const [Electrical6thSemData, setElectrical6thSemData] = useState([]);
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .doc('Electrical Branch')
                .collection('Electrical 4th sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electrical 4th Semester</Text>
...
export default FindAttendanceFourthSemElectrical;
