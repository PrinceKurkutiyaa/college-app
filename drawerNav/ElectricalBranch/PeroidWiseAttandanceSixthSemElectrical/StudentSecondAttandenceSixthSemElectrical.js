...
const StudentSecondAttandenceSixthSemElectrical = () => {
    ...
    const fetchData = async () => {
        //fetching Data
        try {
            const data = await firestore().collection('Attandence').doc('Electrical Branch')
...
export default StudentSecondAttandenceSixthSemElectrical;