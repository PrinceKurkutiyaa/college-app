...
const AttendanceFirstElectronics = () => {
        ...
        <LinearGradient colors={['#FFFFFF', '#f6f6f6']} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{
                ...
                <View style={{ backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth: 3 }}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('Today Sem 1 Computer')}
                    >
                ...
                <View style={{  backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth:3 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('1st Sem Past Attandence')}>
...
export default AttendanceFirstElectronics;