...
const AttendanceSixthElectronics= () => {
            ...
            <View style={{
               ...
               borderWidth:1, borderColor: '#00dc00',backgroundColor:'#383d41',borderRadius:10
                ...
                <View style={{ backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth: 3}}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('Today Sem 6 Computer')}
                    >
                        <Text style={{ fontSize: 20, padding: 20, color: '#fff', paddingHorizontal: 50,fontWeight:'500' }}>
                            Today's
                        </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{  backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth: 3 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('6th Sem Past Attandence')}>
                        <Text style={{ fontSize: 20, padding: 20, color: '#fff',fontWeight:'500' }}>
                            Past Attandence
                        </Text>
                    </TouchableOpacity>
                </View>
...
export default AttendanceSixthElectronics;