...
const AttendanceThirdElectronics = () => {
        ...
        <LinearGradient colors={['#FFFFFF', '#f6f6f6']} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{
                ...
                <View style={{ backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth: 3 }}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('Today Sem 3 Computer')}
                    >
                ...
                <View style={{  backgroundColor: 'white', borderRadius: 20, marginBottom: 20, borderColor: '#00dc00', borderWidth: 3 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('3rd Sem Past Attandence')}>
                        <Text style={{ fontSize: 20, padding: 20, color: 'black',fontWeight:'500' }}>
                            Past Attandence
                        </Text>
                    </TouchableOpacity>
                </View>
...
export default AttendanceThirdElectronics;