...
import PastAttandence from "./PastAttandenceCompFifthSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceFifthSemElectronics = ({ route }) => {
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .collection('Electronics 5th sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 5th Semester</Text>
...
export default FindAttendanceFifthSemElectronics;
