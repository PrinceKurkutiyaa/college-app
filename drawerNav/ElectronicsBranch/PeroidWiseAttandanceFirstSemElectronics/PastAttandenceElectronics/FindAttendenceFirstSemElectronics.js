...
import PastAttandence from "./PastAttandenceCompFirstSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceFirstSemElectronics = ({ route }) => {
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .collection('Electronics 1st sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 1st Semester</Text>
...
export default FindAttendanceFirstSemElectronics;
