...
const PastAttandenceFirstSemElectronics = () => {
  ...
  const fetch = () => {
    if (selected) {
      navigation.navigate('1st Sem Find Attandence', {selectedDate: selected});
    } else {
        Alert.alert(
...
export default PastAttandenceFirstSemElectronics;
