...
import PastAttandence from "./PastAttandenceCompFourthSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceFourthSemElectronics = ({ route }) => {
    const [Electronics6thSemData, setElectronics6thSemData] = useState([]);
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .doc('Electronics Branch')
                .collection('Electronics 4th sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 4th Semester</Text>
...
export default FindAttendanceFourthSemElectronics;
