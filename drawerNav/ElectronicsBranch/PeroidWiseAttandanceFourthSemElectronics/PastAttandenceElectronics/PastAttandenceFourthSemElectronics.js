...
const PastAttandenceFourthSemElectronics = () => {
  ...
  const fetch = () => {
    if (selected) {
      navigation.navigate('4th Sem Find Attandence', {selectedDate: selected});
    } else {
      Alert.alert(
...
export default PastAttandenceFourthSemElectronics;
