...
import PastAttandence from "./PastAttandenceCompSecondSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceSecondSemElectronics = ({ route }) => {
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .collection('Electronics 2nd sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 2nd Semester</Text>
...
export default FindAttendanceSecondSemElectronics;
