...
const PastAttandenceSecondSemElectronics = () => {
  ...
  const fetch = () => {
    if (selected) {
      navigation.navigate('2nd Sem Find Attandence', {selectedDate: selected});
    } else {
        Alert.alert(
...
export default PastAttandenceSecondSemElectronics;
