...
import PastAttandence from "./PastAttandenceCompSixthSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceSixthSemElectronics = ({ route }) => {
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .collection('Electronics 6th sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 6th Semester</Text>
...
export default FindAttendanceSixthSemElectronics;
