...
const StudentFourthAttandenceSixthSemElectronics = () => {
    ...
    const fetchData = async () => {
        //fetching Data
        try {
            const data = await firestore().collection('Attandence').doc('Electronics Branch')
            .collection('Electronics 6th sem').doc(dateString)
            .collection('Peroid 4').get()
...
export default StudentFourthAttandenceSixthSemElectronics;