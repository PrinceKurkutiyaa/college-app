...
import PastAttandence from "./PastAttandenceCompThirdSem";
import LinearGradient from "react-native-linear-gradient";

const FindAttendanceThirdSemElectronics = ({ route }) => {
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .collection('Electronics 3rd sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Electronics 3rd Semester</Text>
...
export default FindAttendanceThirdSemElectronics;
