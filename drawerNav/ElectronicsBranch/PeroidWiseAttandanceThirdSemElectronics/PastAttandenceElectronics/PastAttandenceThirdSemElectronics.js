...
const PastAttandenceThirdSemElectronics = () => {
  ...
  const fetch = () => {
    if (selected) {
      navigation.navigate('3rd Sem Find Attandence', {selectedDate: selected});
    } else {
      Alert.alert(
...
export default PastAttandenceThirdSemElectronics;
