...
const AttendenceTodayFirstElectronics = () => {
  const navigation = useNavigation();
  const [peroid, setPeroid] = useState('1');

  const submit = () => {
    if (peroid == 1) {
      navigation.navigate('Attandence Electronics 1st Peroid');
      console.warn('wtf?');
    } else if (peroid == 2) {
      navigation.navigate('Attandence Electronics 2nd Peroid');
      console.warn('2');
    } else if (peroid == 3) {
      navigation.navigate('Attandence Electronics 3rd Peroid');
      console.warn('3');
    } else if (peroid == 4) {
      navigation.navigate('Attandence Electronics 4th Peroid');
      console.warn('4');
    } else if (peroid == 5) {
      navigation.navigate('Attandence Electronics 5th Peroid');
    } else if (peroid == 6) {
      navigation.navigate('Attandence Electronics 6th Peroid');
      console.warn('6');
    } else {
...
export default AttendenceTodayFirstElectronics;
