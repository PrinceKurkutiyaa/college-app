...
const FindAttendanceFourthSemMechanical = ({ route }) => {
    const [Mechanical6thSemData, setMechanical6thSemData] = useState([]);
    ...
    const fetchData = async () => {
        try {
            const querySnapshot = await firestore()
                ...
                .doc('Mechanical Branch')
                .collection('Mechanical 4th sem')
                .get();
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Mechanical 4th Semester</Text>
...
export default FindAttendanceFourthSemMechanical;
