...
const FindAttendanceSecondSemMechanical = ({ route }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Mechanical 2nd Semester</Text>
...
export default FindAttendanceSecondSemMechanical;
