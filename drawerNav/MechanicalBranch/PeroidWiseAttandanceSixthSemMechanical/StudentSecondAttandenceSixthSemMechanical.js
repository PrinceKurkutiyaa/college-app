...
const StudentSecondAttandenceSixthSemMechanical = () => {
    ...
    const fetchData = async () => {
        //fetching Data
        try {
            const data = await firestore().collection('Attandence').doc('Mechanical Branch')
...
export default StudentSecondAttandenceSixthSemMechanical;