...
const FindAttendanceComputerFourth = ({route}) => {
  ...
  const exportToExcel = async () => {
    ...
    const path = `${RNFS.DownloadDirectoryPath}/attendance_4th_Sem${selectedDate}.xlsx`;
...
export default FindAttendanceComputerFourth;
