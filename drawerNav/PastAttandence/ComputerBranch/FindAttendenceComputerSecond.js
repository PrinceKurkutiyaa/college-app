...
import {View, Text, FlatList, ScrollView, Button,TouchableOpacity,Alert} from 'react-native';
...
const FindAttendanceComputerSecond = ({route}) => {
      ...
      <LinearGradient colors={['#FFFFFF', '#f6f6f6']}>
        ...
        <View
          ...
          <View
            ...
            <Text style={{color: 'black', paddingHorizontal: 5}}>Present</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
            ...
            <View
              ...
              <Text style={{color: 'black', paddingHorizontal: 5}}>Absent</Text>
            </View>
          </View>
        </View>
...
export default FindAttendanceComputerSecond;
