...
const FindAttendanceComputerSixth = ({route}) => {
  ...
  const exportToExcel = async () => {
    ...
    const path = `${RNFS.DownloadDirectoryPath}/attendance_6th_Sem ${selectedDate}.xlsx`;
...
export default FindAttendanceComputerSixth;
