...
const FindAttendanceComputerThird = ({route}) => {
  ...
  const exportToExcel = async () => {
    ...
    const path = `${RNFS.DownloadDirectoryPath}/attendance_3rd_Sem${selectedDate}.xlsx`;
...
export default FindAttendanceComputerThird;
