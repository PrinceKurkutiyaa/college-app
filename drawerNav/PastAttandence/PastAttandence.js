...
const PastAttandence = () => {
  ...
  const fetch = () => {
    if (selected) {
      navigation.navigate('6th Sem Find Attandence', {selectedDate: selected});
    } else {
      Alert.alert("Please select a date","Kindly press on the date which you want data from!")
    }
  };
  ...
  return (
    <LinearGradient
      ...
      style={{flex: 1, justifyContent: 'center', backgroundColor: '#00ff66'}}>
      <View
        style={{
          margin:10,
          borderWidth: 1,
