...
const FindAttendanceFourthSemPlastic = ({ route }) => {
    const [Plastic6thSemData, setPlastic6thSemData] = useState([]);
    ...
    return (
        <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: '900', paddingBottom: 10,color:'white' }}>Plastic 4th Semester</Text>
...
export default FindAttendanceFourthSemPlastic;
