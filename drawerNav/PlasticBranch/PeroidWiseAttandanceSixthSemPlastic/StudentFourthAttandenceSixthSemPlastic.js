...
const StudentFourthAttandenceSixthSemPlastic = () => {
    ...
    const fetchData = async () => {
        //fetching Data
        try {
            const data = await firestore().collection('Attandence').doc('Plastic Branch')
...
export default StudentFourthAttandenceSixthSemPlastic;